...
const hindiPricingFaqs = [
  {
    ...
    answer: "हाँ, पूरी तरह मुफ़्त है। यहाँ कोई 7-दिन का ट्रायल नहीं है, कोई दैनिक फ़ाइल कोटा नहीं है, कोई क्रेडिट कार्ड नहीं मांगा जाता, और न ही कोई पेड प्रो बटन है।"
  },
  {
